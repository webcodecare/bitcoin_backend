      ...
      <Tabs defaultValue="cms" className="space-y-4">
        ...
        <TabsContent value="cms" className="space-y-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <h2 className="text-lg sm:text-xl font-semibold">Website Content Blocks</h2>
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <CardDescription className="capitalize text-xs sm:text-sm">{block.section} section</CardDescription>
                        </div>
                      </div>
        ...
        <TabsContent value="testimonials" className="space-y-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <h2 className="text-lg sm:text-xl font-semibold">Customer Testimonials</h2>
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <CardDescription className="text-xs sm:text-sm">{testimonial.role} at {testimonial.company}</CardDescription>
                        </div>
                      </div>
        ...
        <TabsContent value="pricing" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-base sm:text-lg">Pricing Page Content</CardTitle>
              <CardDescription className="text-xs sm:text-sm">Manage pricing plan descriptions and call-to-action text</CardDescription>
            </CardHeader>
            <CardContent>
              {pricingLoading ? (
                ...
                <div className="space-y-4">
                  {pricingContent.map((content) => (
                    <div key={content.id} className="flex items-center justify-between p-3 sm:p-4 border rounded-lg">
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        <DollarSign className="h-4 w-4 sm:h-5 sm:w-5 text-green-500" />
                        <div>
                          <h4 className="font-medium text-sm sm:text-base">{content.title}</h4>
                          <p className="text-xs sm:text-sm text-muted-foreground capitalize">{content.planTier} plan</p>
      ...
      <Dialog open={isBlockDialogOpen} onOpenChange={setIsBlockDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedBlock ? "Update website content block" : "Add new content section to the website"}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label className="text-sm">Make this content visible</Label>
            </div>
          </div>
          <DialogFooter className="flex flex-col sm:flex-row gap-2">
            ...
            <Button onClick={handleSaveBlock} disabled={createBlockMutation.isPending || updateBlockMutation.isPending} className="w-full sm:w-auto">
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label className="text-sm">Display this testimonial</Label>
            </div>
          </div>
          <DialogFooter className="flex flex-col sm:flex-row gap-2">
            <Button variant="outline" onClick={() => setIsTestimonialDialogOpen(false)} className="w-full sm:w-auto">
              Cancel
            </Button>
            <Button onClick={handleSaveTestimonial} disabled={createTestimonialMutation.isPending || updateTestimonialMutation.isPending} className="w-full sm:w-auto">
              <Save className="h-4 w-4 mr-2" />
